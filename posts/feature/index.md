...
{% video "castle_sped.mp4", "Visualization of castle (483)", true, false %}
...
{% img "cat.jpg", "[*(Consider them.)*](https://aisafety.dance/)" %} 
...
{% img "hen.jpg", "ImageNet class 8: *hen*. [Source.](https://unsplash.com/photos/brown-and-red-he-n-G61iAuzI9NQ)"  %} 
...
{% video "app0.mp4" "Visualization of fowl (483)" true false %}
...
{% video "app2.mp4", "Result after optimizing for transformational robustness."  %}
...
{% video "conclusion.mp4" "From top-left to bottom-right: hen (8), pelican (144), leopard (288), hammer (587), iPod (605), slot (800), potpie (964), scuba diver (983)." false true
 %}
...
{% video "alien3.mp4", "Left: 'hen' (8). Right: 'robin' (15)", true  %}
